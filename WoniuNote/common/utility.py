...
def send_email(receiver, ecode):
    sender = '蜗牛商城<dzz707643733qq@163.com>'  # 你的邮箱账号和发件者签名
    ...
    smtpObj = SMTP_SSL('smtp.163.com')  # 建议与QQ邮件服务器的连接
    # 通过你的邮箱账号和获取到的授权码登录QQ邮箱 dzz13571022547DD
    smtpObj.login(user='dzz707643733qq@163.com', password='TNOUHCFCOSENOXIQ')
    # 指定发件人，收件人和邮件内容
...
if __name__ == '__main__':
    code = gen_email_code()
    print(code)
    send_email('dzz707643733qq@163.com',code)
